...
import { CanvasTexture, DataTexture, Mesh, OrthographicCamera, PlaneGeometry, RenderTarget, SRGBColorSpace, Texture, Vector2, type WebGPURenderer } from 'three/webgpu'
...
export function createBakingEmissivityMap(data: PlanetData, surfaceTex: DataTexture, biomesTex: DataTexture, biomeEmissiveTex: DataTexture): Mesh {
  const geometry = ComponentHelper.createSphereGeometryComponent(data.planetMeshQuality)
  geometry.computeTangents()
