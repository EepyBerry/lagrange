  ...
  <dialog ref="dialog" class="lg" @abort="close">
    <section>
      <header class="dialog-header">
        ...
        <button v-if="closeable" @click="close" class="lg icon-button dialog-close" :aria-label="$t('a11y.action_close_dialog')">
...
const $props = defineProps<{ showTitle?: boolean; showActions?: boolean; closeable?: boolean; preventClickClose?: boolean }>()
onMounted(() => {
