<template>
  <div v-if="specialDay" class="special-day-box" :title="$t(specialDay!.translationKey)">
...
import { checkSpecialDay, getSpecialOverlay, type SpecialDayInfo } from '@/core/extras';
