  ...
  <ParameterGrid>
    ...
    <ParameterGroup toggleable>
      ...
      <template #content>
        ...
        <ParameterSlider
          id="p-wmetal"
          v-model="EDITOR_STATE.planetData.planetWaterMetalness"
          :step="0.01"
          :min="0"
          :max="1"
        >
        ...
        <ParameterSlider
          id="p-grough"
          v-model="EDITOR_STATE.planetData.planetGroundRoughness"
          :step="0.01"
          :min="0"
          :max="1"
        >
        ...
        <ParameterSlider
          id="p-gmetal"
          v-model="EDITOR_STATE.planetData.planetGroundMetalness"
          :step="0.01"
          :min="0"
          :max="1"
        >
