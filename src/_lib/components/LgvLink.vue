...
a.lgv[variant='button'].router-link-active {
  ...
  &.contrast { background: var(--lg-contrast-active); }
  &.success { background: var(--lg-success-active); }
  &.info { background: var(--lg-info-active); }
  &.warn { background: var(--lg-warn-active); }
}
a.lgv[variant='dark'].router-link-active {
  color: var(--lg-text);
  background: var(--lg-button-dark-active);
  pointer-events: none;
  &.contrast { background: var(--lg-button-dark-contrast-active); }
}
</style>